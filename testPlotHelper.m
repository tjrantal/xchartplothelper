javaaddpath('build/libs/xchartplothelper-1.0.jar'); %Point this to the .jar file you compiled
t = [0:0.01:10];
t2 = [15:0.01:20];
s1 = sin(2*pi*t);
s2 = sin(2*pi*t2);
...
chart1.appendAndSavePNG('chart1chart2chart3.png',chart2.appendBI(chart3.getBI()));